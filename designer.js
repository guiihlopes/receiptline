...
const receiptline = require("./lib/receiptline");
...
const rasterize = async (receiptmd, printer, encoding) => {
  ...
  await page.setContent(
    `<!DOCTYPE html><html><head><meta charset="utf-8"><style>*{margin:0}</style></head><body>${svg}</body></html>`
  );
